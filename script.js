...
// to Start on Scroll Page 0 video.
gsap.to("#page>video",{
    scrollTrigger:{
        trigger:`#page>video`,
        start:`1% top`,
...
// Pin that video (no loop req.)
//gsap is used to manage online animination video
gsap.to("#page",{
    scrollTrigger:{
        trigger:`#page`,
        start:`top top`,
        ...
        scroller:`#main`,
        pin:true // it will end the movie where we have our trigger currently
                 // you can say it will help in overlaping the video
    }
})

// Disapper the Vision pro logo 
gsap.to("#page-bottom",{
    scrollTrigger:{
        trigger:`#page-bottom`,
        start:`1% top`,
...
//page 1
// time.line help to magage timings of video
var tl = gsap.timeline({
    scrollTrigger:{
        trigger:`#page1`,
        start:`top top`, //when will the video start
        scrub:0, // this will help to move animation back and fore
        scroller:`#main`,
        pin:true
    }
})
